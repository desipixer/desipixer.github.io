...
"use strict";
eval("\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _blog = __webpack_require__(/*! ./blog */ \"./src/client/app2/blog.js\");\n\nvar _post = __webpack_require__(/*! ./post */ \"./src/client/app2/post.js\");\n\nvar _settings = __webpack_require__(/*! ./settings */ \"./src/client/app2/settings.js\");\n\nvar _util = __webpack_require__(/*! ./util.url */ \"./src/client/app2/util.url.js\");\n\nvar _util2 = __webpack_require__(/*! ./util.post */ \"./src/client/app2/util.post.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n//import router from 'vue-router';\n//import Vue from 'vue';\n//import Vue from 'vue';\nvar settings = _settings.Settings.getSettings();\nvar blog = new _blog.Blog(settings.id, null);\n\n// init vue components\nvar postComponent = new Vue({\n    data: {\n        \"blogData\": []\n    },\n    el: '#myPosts',\n    methods: {\n        showTitle: function showTitle() {\n            console.log(this.title);\n        }\n    }\n});\n\nvar nextButton = new Vue({\n    data: {\n        \"myData\": \"\"\n    },\n    el: '#btnNextPosts',\n    methods: {\n        getNext: function getNext(event) {\n            var reqUrl = _util.UrlUtil.getGoogleApiUrl(blog.id, settings.key, settings.maxResults, blog.getBlogNextToken());\n            _axios2.default.get(reqUrl).then(function (res) {\n                blog.setBlogPrevToken(blog.getBlogNextToken());\n                blog.setBlogNextToken(res.data.nextPageToken);\n                populateData(res.data);\n            });\n        }\n    }\n});\n\nvar prevButton = new Vue({\n    data: {\n        \"myData\": \"\"\n    },\n    el: '#btnPrevPosts',\n    methods: {\n        getPrev: function getPrev(event) {\n            var reqUrl = _util.UrlUtil.getGoogleApiUrl(blog.id, settings.key, settings.maxResults, blog.getBlogPrevToken());\n            _axios2.default.get(reqUrl).then(function (res) {\n                //blog.setBlogPrevToken(blog.getBlogNextToken());\n                blog.setBlogNextToken(res.data.nextPageToken);\n                populateData(res.data);\n            });\n        }\n    }\n});\n\nvar getSiteBtn = new Vue({\n    el: '#getSiteId',\n    methods: {\n        getSite: function getSite() {\n            //get value of siteName\n            var siteName = document.getElementById('siteName');\n            if (siteName) {\n                var val = siteName.value;\n                if (val) {\n                    try {\n                        var myUrl = new URL(val);\n                        if (myUrl.hostname) {\n                            // full sitename;\n                            var mySite = myUrl.protocol + \"//\" + myUrl.hostname;\n                            console.log(mySite);\n                            getBlogId(mySite);\n                        }\n                    } catch (ex) {\n                        //error\n                    }\n                } else {\n                        // error.\n                    }\n            }\n        }\n    }\n});\n\nfunction main() {\n    var settings = _settings.Settings.getSettings();\n\n    var reqUrl = _util.UrlUtil.getGoogleApiUrl();\n    _axios2.default.get(reqUrl).then(function (res) {\n        console.log(res.status);\n\n        console.log(res.data);\n        // set next page token.\n        blog.setBlogNextToken(res.data.nextPageToken);\n        populateData(res.data);\n    });\n}\n\nfunction populateData(data) {\n    var rawEntry = data.items;\n    var postData = [];\n    if (rawEntry) {\n        console.log(rawEntry);\n        rawEntry.forEach(function (v, i) {\n            var blogPost = new _post.Post(v);\n            postData.push(blogPost);\n        });\n\n        updatePostsContent(postData);\n    }\n}\n\nfunction updatePostsContent(data) {\n    postComponent.blogData = data;\n}\n\nfunction getBlogId(blogUrl) {\n    var reqUrl = _util.UrlUtil.getBlogIdByUrl(blogUrl);\n    return _axios2.default.get(reqUrl).then(function (res) {\n        console.log(res.data);\n        var data = res.data;\n        blog = new _blog.Blog(data.id, data.url);\n        reqUrl = _util.UrlUtil.getGoogleApiUrl(data.id, settings.key, settings.maxResults, null);\n        _axios2.default.get(reqUrl).then(function (res) {\n            console.log(res.status);\n            //debugger;\n            console.log(res.data);\n            // set next page token.\n            blog.setBlogNextToken(res.data.nextPageToken);\n            populateData(res.data);\n        });\n    });\n}\n\nmain();\n\n//# sourceURL=webpack:///./src/client/app2/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.Post = undefined;\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _util = __webpack_require__(/*! ./util.post */ \"./src/client/app2/util.post.js\");\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Post = exports.Post = function () {\n    function Post(obj) {\n        _classCallCheck(this, Post);\n\n        this.id = obj.id;\n        this.images = _util.PostUtil.getImages(obj.content);\n        this.url = obj.url;\n        this.thumb = _util.PostUtil.getThumb(this.images[0]);\n        this.title = obj.title;\n        this.visible = false;\n    }\n\n    _createClass(Post, [{\n        key: 'getImages',\n        value: function getImages() {\n            return this.images;\n        }\n    }, {\n        key: 'getThumb',\n        value: function getThumb() {\n            return this.thumb;\n        }\n    }]);\n\n    return Post;\n}();\n\n//# sourceURL=webpack:///./src/client/app2/post.js?");

/***/ }),

/***/ "./src/client/app2/settings.js":
/*!*************************************!*\
  !*** ./src/client/app2/settings.js ***!
  \*************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Settings = exports.Settings = function () {\n    function Settings() {\n        _classCallCheck(this, Settings);\n    }\n\n    _createClass(Settings, null, [{\n        key: \"getSettings\",\n        value: function getSettings() {\n            return {\n                \"id\": \"4985646326158465936\",\n                \"key\": \"AIzaSyBZvR46qyUilZ6Fl5vn9oPnLZtYHnqSknE\",\n                \"startIndex\": 1,\n                \"maxResults\": 100\n            };\n        }\n    }]);\n\n    return Settings;\n}();\n\n//# sourceURL=webpack:///./src/client/app2/settings.js?");

/***/ }),

/***/ "./src/client/app2/util.post.js":
/*!**************************************!*\
  !*** ./src/client/app2/util.post.js ***!
  \**************************************/
/*! no static exports found */
