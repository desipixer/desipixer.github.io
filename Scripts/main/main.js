...
app.service('service.data', function () {
    ...
    let postBlogsiteList = [
        ...
        { blogId: '5184898496929684986', blogURL: 'https://sareepixer.blogspot.com/', category: 1 },
        { blogId: '3744279159256825106', blogURL: 'https://saree-pixer.blogspot.com/', category: 1 },
        { blogId: '6816867960560383037', blogURL: 'https://glamspots.blogspot.com/', category: 1 },
        { blogId: '2687453290454507255', blogURL: 'https://glampixer.blogspot.com/', category: 1 },
        {
